...
Review.create(content: "Beautiful club, very friendly staff", rank: 8, user: u1, club: c1, date: "01/02/2019")
Review.create(content: "Rude staff, very dissapointing experience", rank: 2, user: u2, club: c2, date: "01/02/2019")
r3 = Review.create(content: "Gorgeous course, good value for money", rank: 9, user: u3, club: c4, date: "01/02/2019")
r4 = Review.create(content: "Expensive green fee but a very memorable experience playing this historical course!", rank: 8, user: u4, club: c3, date: "01/02/2019")
r5 = Review.create(content: "Average experience, very busy!", rank: 5, user: u5, club: c5, date: "01/02/2019")
r6 = Review.create(content: "Very busy but a good course for beginners", rank: 7, user: u1, club: c5, date: "01/02/2019")
r7 = Review.create(content: "Great day out playing with the whole family, would highly recommend!", rank: 10, user: u2, club: c4, date: "01/02/2019")
r8 = Review.create(content: "The greens need some work, it has been a dry summer and you can tell that the course has suffered!", rank: 4, user: u3, club: c1, date: "01/02/2019")
r9 = Review.create(content: "A beautiful course - You can see the sea from every hole!", rank: 9, user: u4, club: c2, date: "01/02/2019")
